...
namespace SunTech.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        {
            ViewData["TipoProdutoId"] = new SelectList(_context.Set<TipoProduto>(), "Id", "NomeTipoProduto");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProduto, FotoProduto, TipoProdutoId,PrecoProduto")] Produto produto)
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.Set<TipoProduto>(), "Id", "NomeTipoProduto", produto.TipoProdutoId);
            return View(produto);
        }

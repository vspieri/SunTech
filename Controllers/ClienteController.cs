...
namespace SunTech.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCliente,CpfCliente,EmailCliente,SenhaCliente,TelefoneCliente,EnderecoCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCliente,CpfCliente,EmailCliente,SenhaCliente,TelefoneCliente,EnderecoCliente")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
